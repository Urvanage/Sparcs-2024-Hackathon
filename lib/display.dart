          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                const Row(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 24,
                        color: Color.fromRGBO(146, 168, 0, 1),
                ...
                //     fillColor: const Color.fromRGBO(194, 228, 254, 1),
                //     filled: true,
                //     border: OutlineInputBorder(
                //       borderRadius: BorderRadius.circular(40),
                //       borderSide: const BorderSide(
                //         color: Color.fromRGBO(194, 228, 254, 1),
                //       ),
                //     ),
                //   ),
                //   hint: const Text('업종'),
                ...
                //     });
                //   },
                //   items: <String>['한식_일반','한식_한정식','한식_면류','한식_육류','한식_찌개류','한식_해산물','한식_분식','한식_기타','일식','양식','중식','기타양식','세탁업','이미용업','목욕업','숙박업'].map<DropdownMenuItem<String>>((String value) {
