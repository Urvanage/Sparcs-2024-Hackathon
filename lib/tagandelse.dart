...
class _TagandRecommState extends State<TagandRecomm> {
  ...
  List<Map<String, List<String>>> good = [
    ...
    {
      'facility': ["교통이 편리해요", "매장이 깨끗해요", "매장이 넓어요"]
    },
    {
      'atmosphere': ["연인과 함께 오기 좋아요", "가족과 함께 오기 좋아요", "친구와 함께 오기 좋아요"]
    },
  ];
  ...
  List<Map<String, List<String>>> bad = [
    ...
    {
      'service': ["음식이 늦게 나와요", "배달이 느려요"]
    },
    {
      'facility': ["매장이 더러워요", "교통이 불편해요", "주차가 불편해요"]
    },
    {
      'atmosphere': ["매장이 시끄러워요"]
    },
  ];

  List<String> taste = ["음식이 맛있어요", "양이 많아요", "양이 적당해요", "가성비가 좋아요", "재료가 신선해요", "매콤해요", "메뉴가 다양해요", "지역 특색을 살린 메뉴가 있어요", "비건용 메뉴가 있어요", "간이 세요", "간이 약해요", "양이 적어요", "향신료가 강해요"];
  List<String> service = ["음식이 빨리 나와요", "친절해요", "배달이 빨라요", "다음에 또 올래요", "음식이 늦게 나와요", "배달이 느려요"];
  List<String> facility = ["교통이 편리해요", "매장이 깨끗해요", "매장이 넓어요", "매장이 더러워요", "교통이 불편해요", "주차가 불편해요"];
  List<String> atmosphere = ["연인과 함께 오기 좋아요", "가족과 함께 오기 좋아요", "친구와 함께 오기 좋아요", "매장이 시끄러워요"];
